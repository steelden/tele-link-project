...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"TeleLink.TeleLink.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"TeleLink.TeleLink";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"TeleLink.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"TeleLink/TeleLink.lnk"_q;
	const auto old = u"TeleLink Win (Unofficial)/TeleLink.lnk"_q;
